...
import { NewElementBuilder, SVG_NAMESPACE, RenderResult, Template, normalizeProperty } from "@glimmer/runtime";
...
function render(template: Template, context = {}) {
  ...
  let elementBuilder = NewElementBuilder.forInitialRender(cursor);
